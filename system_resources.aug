...
<document signature="Hero Lab Structure">
  ...
  <!-- color used for option summaries on the "select option" form -->
  <resource
    id="seloptsumm"
    issystem="yes">
    <color
  ...
  <!-- bitmap used for the 'new update' icon on the game updates form
  -->
  <resource
    id="gmupdtnew"
    issystem="yes"
  ...
  <!-- bitmap used for the placeholder cover image in the encounter library
  -->
  <resource
    id="enccovplac"
    issystem="yes"
    isbuiltin="yes">
    <bitmap
      bitmap="encounter_cover_placeholder.bmp"
      istransparent="no">
      </bitmap>
    </resource>
